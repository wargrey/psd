...
(define 0x40c : (-> Integer Bytes String (List Positive-Real) PSD-Thumbnail)
  (lambda [id block name argl]
    (psd-thumbnail id name
                   ...
                   (parse-size block 4  4 exact-positive-integer?) ; width
                   (parse-size block 8  4 exact-positive-integer?) ; height
                   (parse-size block 12 4 exact-positive-integer?) ; padded row bytes
                   (parse-size block 16 4 exact-positive-integer?) ; total size
                   (parse-size block 20 4 exact-positive-integer?) ; compressed size
